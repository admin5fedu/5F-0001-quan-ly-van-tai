...
1. Read the skill file in the project-local adapter at `.agents/skills/ui-ux-pro-max/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\ui-ux-pro-max\SKILL.md`.
