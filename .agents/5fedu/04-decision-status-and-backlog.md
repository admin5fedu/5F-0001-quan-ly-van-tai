...
| Chuyến xe/CT chỉ dùng trạng thái duyệt | **SUPERSEDED** | 2026-06-10 → owner 2026-06-15 | Thay bằng tách thực hiện (CT) vs duyệt (cha→con). Xem `06-decision-status.md` §2026-06-15. |
...
*   **Mô tả Quy tắc (Rule Spec)**:
    ...
    4. Áp dụng quy trình kiểm thử E2E chéo vai trò: Dùng tối thiểu 3 tài khoản cấp bậc khác nhau đăng nhập thực tế để kiểm tra ẩn/hiện UI, thử hành động trái phép, và kiểm tra quyền được áp dụng lập tức. Harness cụ thể TAH: `14-production-e2e-harness.md` (`production-multi-role`, `production-permissions-matrix`, `production-trip-execution`).
