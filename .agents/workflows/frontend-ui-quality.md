# frontend-ui-quality Skill

1. Read the skill file in the project-local adapter at `.agents/skills/frontend-ui-quality/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\frontend-ui-quality\SKILL.md`.
