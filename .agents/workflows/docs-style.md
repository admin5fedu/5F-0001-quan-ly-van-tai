...
1. Read the skill file in the project-local adapter at `.agents/skills/docs-style/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\docs-style\SKILL.md`.
