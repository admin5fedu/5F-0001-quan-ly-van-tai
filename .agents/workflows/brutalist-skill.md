...
1. Read the skill file in the project-local adapter at `.agents/skills/brutalist-skill/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\brutalist-skill\SKILL.md`.
