...
1. Read the skill file in the project-local adapter at `.agents/skills/security-best-practices/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\security-best-practices\SKILL.md`.
