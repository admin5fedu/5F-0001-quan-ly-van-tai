...
1. Read the skill file in the project-local adapter at `.agents/skills/image-to-code-skill/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\image-to-code-skill\SKILL.md`.
