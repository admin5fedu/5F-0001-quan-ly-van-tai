...
const EmployeeProfilePreviewPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    document.title = `${txt('employee.pdf.title')} - ${employee.ho_va_ten || employee.ho_ten} (${employee.ma_nhan_vien})`;
  ...
  return (
    ...
    >
      <div className="employee-profile-preview-toolbar flex items-center justify-between gap-3 px-4 py-3 bg-card border-b border-border shadow-sm shrink-0 no-print">
        <button
          type="button"
          onClick={handleClose}
