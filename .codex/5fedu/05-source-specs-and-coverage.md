...
- **`vt_chuyen_xe`**: `id int8`, `ngay`, `id_tai_xe`, `id_xe`, `so_chuyen`, `tong_tien_luong`, `tong_phi`, `ghi_chu`, `trang_thai` (Chưa duyệt/Đã duyệt/Không duyệt), `id_nguoi_tao`, `tg_tao`, `tg_cap_nhat`.
- **`vt_chuyen_xe_ct`**: `id int8`, `id_chuyen_xe`, `id_dia_diem`, `tien_luong` (thực nhận chuyến), `chi_phi` (chi phí chuyến, mặc định tham chiếu 80,000), `ghi_chu`, `phe_duyet` (Chưa duyệt/Đã duyệt/Không duyệt), `tg_tao`, `tg_cap_nhat`; cột `trang_thai` nếu còn trong DB chỉ là legacy mirror, không hiển thị/không nhập/không dùng làm action.
- **`vt_luong`**: `id int8`, `nam`, `thang`, `id_tai_xe`, `tong_luong_chuyen` (tổng lương chuyến đi thực tế), `tong_chi_phi_chuyen` (tổng chi phí chuyến thực tế), `tru_tien_khac` (trừ tiền khác/ứng), `tong_chi_phi_khac` (chi phí phát sinh ngoài chuyến), `tong_con_lai` (tự tính = lương chuyến - trừ tiền khác), `ghi_chu_khoan_tru`, `ghi_chu_chi_phi`, `trang_thai` (Chưa duyệt/Đã duyệt/Không duyệt), `id_nguoi_tao`, `tg_tao`, `tg_cap_nhat`.
